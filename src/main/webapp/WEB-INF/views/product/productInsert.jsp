...
<body>
    ...
    <div class="container-fulid" style="height: 900px; margin-top: 100px;">
    		...
    		<form action="./productInsert" method="post" id="f" enctype="multipart/form-data">
    		<div class="col-md-6 mx-auto">
    			...
    			<div class="form-floating">
				  ...
				  <textarea class="form-control" name="explain" id="floatingTextarea2" style="height: 100px"></textarea>
				</div>
    			
    			<div class="form-floating">
				  <label for="floatingInput">기타 사항</label>
				  <textarea class="form-control" name="etc" id="floatingInput"></textarea>
				</div>
				<br>
				<div class="input-group fileDiv">
				  <input type="file" class="form-control file" name="files" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
...
<script type="text/javascript">
	...
	$('.submitDel').click(function(){
		let check = confirm('등록중인 상품이 있습니다. 정말 취소하시겠습니까?');
		if(check){
